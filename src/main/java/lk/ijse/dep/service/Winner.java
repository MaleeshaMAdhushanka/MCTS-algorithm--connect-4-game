...
public class Winner {
    ...
    public Winner(Piece winingPiece){
        this.winningPiece = winingPiece;
        this.col1 = -1;
        this.row1 = -1;
        this.col2 = -1;
        this.row2 = -1;
    ...
    public Winner(Piece winingPiece, int col1, int row1, int col2, int row2){
        this.winningPiece = winingPiece;
        this.col1 = col1;
        this.row1 = row1;
        this.col2 = col2;
    ...
    public Piece getWiningPiece(){
        return winningPiece;}

    public void setWiningPiece(Piece winingPiece) {this.winningPiece = winingPiece;}
